...
import portrait_gif from "../public/profile.gif";
        ...
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
              <button onClick={() => window.open('https://instagram.com/jules_ndrw?igshid=MzRlODBiNWFlZA==')}>
                <AiFillInstagram />
              </button>

              <button onClick={() => window.open('https://www.linkedin.com/in/julian-liaw')}>
                <AiFillLinkedin />
              </button>
          ...
          <div>
            ...
            <h3 className="text-2xl py-5 dark:text-white md:text-3xl text-center">
                <strong>
